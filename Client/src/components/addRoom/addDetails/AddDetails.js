...
const AddDetails =()=>{
    ...
    const{state:{details:{title, desciption, price}},dispatch}=useValue()
    ...
    const handleCostTypeChange=(e)=>{
        ...
        if(costType === 0){
            ...
            dispatch({type:'UPDATE_DETAILS', payload:{price:150}})
        }
    }
    ...
    return (
        ...
        >
            ...
            />
            <InfoField 
            mainProps={{name:'description',label:'Description', value:desciption}}
            minLength={10}
